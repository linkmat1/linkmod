 ...
 */
final class Version20200308165756 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE mods ADD brand_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE mods ADD CONSTRAINT FK_631EF2FA44F5D008 FOREIGN KEY (brand_id) REFERENCES brand (id)');
        $this->addSql('CREATE INDEX IDX_631EF2FA44F5D008 ON mods (brand_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_631EF2FA44F5D008 ON mods');
        $this->addSql('ALTER TABLE mods DROP brand_id');
    }
}
