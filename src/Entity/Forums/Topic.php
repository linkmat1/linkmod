...
class Topic
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Forums\Tag", inversedBy="topics")
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Forums\Message", mappedBy="topic")
     */
    private Collection $messages;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Forums\Message")
